...
- [Configuration > Custom LED Theme](#custom-LED-Theme) - Enable and configure a custom LED theme.
...
- [Configuration > Macro](#add-ons-macro) - Enable and configure macro settings.
...
This section is for creating software macros that send a sequence of inputs and configuring other macro settings.

TODO: Determine if Macro Settings belong in separate section or not.
